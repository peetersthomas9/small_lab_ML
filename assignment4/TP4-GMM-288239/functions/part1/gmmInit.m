...
[N M]=size(X);
K=params.k; 
Priors0=ones(1,K)*1/K; %assume that all have the same value 
%initialize Mu and labels with kmeans
[labels0, Mu0, Mu_init, iter] =  kmeans(X,K,params.init,params.d_type,params.max_iter_init,0);
for i=1:K
    % initialize covariance with Mu0 and labels0
